...
echo '01' > serial && touch index.txt:
  cmd.run: 
    ...
    - creates: /etc/elasticsearch/shield/ca/serial
...
#openssl req -days 3650 -batch -nodes -new -keyout private/server.key -out /etc/ssl/private/server.csr:
#  cmd.run:
#    - cwd: /etc/elasticsearch/shield/ca
#    - creates: /etc/elasticsearch/shield/ca/private/server.csr

#openssl x509 -req -days 3650 -in private/server.csr -out server.crt -CA ca.crt -CAkey private/ca.key -CAcreateserial:
#  cmd.run:
#    - cwd: /etc/elasticsearch/shield/ca
